...
module.exports = async (layer, sliceName) => {
    ...
    const createModelStructure = async () => {
        try {
            ...
            console.log(`Не вийшло створити модель для ${sliceName}`, e);
        }
    };
    ...
    const createReduxSlice = async () => {
        try {
            ...
            console.log('Не вийшло стоворити редакс слайс', e);
        }
    };
    ...
    const createSchemaType = async () => {
        try {
            ...
            console.log('Не вийшло створити тип для стейт схеми', e);
        }
    };
